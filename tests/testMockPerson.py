...
def test_genPhoneNumber():
    ...
    '345', '346', '347', '348', '349', '356', '357', '359', '362', '365', '366', '389', '398', '431', '441', '462',
    '466', '468', '472', '474', '476', '478', '485', '486', '488', '489', '493', '494', '495', '496', '498', '499',
    '542', '543', '545', '551', '552', '556', '571', '572', '573', '574', '577', '579', '584', '586', '587', '589',
    '597', '598', '627', '629', '641', '649', '658', '662', '663', '664', '665', '667', '692', '663', '694', '697',
...
def test_insert_database():
    q = "Insert Into wsyw0syblihfee10.postal_code Values ('0000','Chisinau')"
    q2 = "Select * from wsyw0syblihfee10.postal_code where cPostalCode = '0000'"
    con = base.create_db_connection("klbcedmmqp7w17ik.cbetxkdyhwsb.us-east-1.rds.amazonaws.com", "gvtdyyofw9hh1rvk",
                                    "wxuzae9o52nstbzp", "wsyw0syblihfee10")
...
def test_person_db():
    ...
    q2 = "Select * from wsyw0syblihfee10.persons where firstname = 'Alex'"
    con = base.create_db_connection("klbcedmmqp7w17ik.cbetxkdyhwsb.us-east-1.rds.amazonaws.com", "gvtdyyofw9hh1rvk",
                                    "wxuzae9o52nstbzp", "wsyw0syblihfee10")
